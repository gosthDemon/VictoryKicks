            ...
            <div class="form col-md-8">
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control number" id="buy_in" name="buy_in" value="{{old("buy_in")}}" required>
                        @error('buy_in')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control number" id="minimum_price" name="minimum_price" value="{{old("minimum_price")}}" required>
                        @error('minimum_price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control number" id="sale_price" name="sale_price" value="{{old("sale_price")}}" required>
                        @error('sale_price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="colors" name="colors" value="{{old("colors")}}" required>
                        @error('colors')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <input type="textarea" class="form-control" id="size" name="size" value="{{old("size")}}" required>
                        @error('size')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  class="form-control" id="description" name="description" rows="4" cols="50" value="{{old("description")}}">
                    @error('description')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
